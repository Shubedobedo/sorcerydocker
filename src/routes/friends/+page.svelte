        ...
        <div class="request-row">
          ...
          <div class="actions">
            <button class="btn btn-primary btn-sm" onclick={() => acceptRequest(req.id)}
              >Accept</button
            >
            <button class="btn btn-secondary btn-sm" onclick={() => rejectRequest(req.id)}
              >Reject</button
            >
          </div>
        </div>
        ...
        {#each data.friends as f}
          <div class="friend-card">
            <div class="friend-card-top">
              ...
              <button
                class="remove-btn"
                onclick={() => removeFriend(f.id, f.friend.name || f.friend.email)}
